...
class MPViT(nn.Module):
    ...
    def forward(self, x):
        ...
        print(x.shape,'mpvit-2')
        # x = x.permute(0, 1, 2, 3).view(B, -1, H, W)
...
if __name__ == "__main__":
    ...
    model = mpvit_small()
    model.eval()
    # inputs = torch.randn(1, 3, 192, 640)
    inputs = torch.randn(1, 3, 24, 80)
    # inputs = torch.randn(1, 3, 24, 80)
    # inputs = torch.randn(1, 3, 12, 40)
