...
#         description='Simple testing function for MG-Mono models.')
#
...
#     encoder = networks.MGMono(model=args.model,
#                                     height=feed_height,
#                                     width=feed_width)
#
...
#
#             name_dest_im = os.path.join(output_directory, "{}_47disp.jpeg".format(output_name))
