...
#         # print(inv_K.size(),"inv_K")
#         # print(depth.size(), "depth")
#         cam_points = torch.matmul(inv_K[:, :3, :3], self.pix_coords)
#         # print(cam_points.size(), "cam_points-0")
#         cam_points = depth.view(self.batch_size, 1, -1) * cam_points
#         # print(cam_points.size(), "cam_points-1")
#         # print(depth.size(), "depth-1")
#         cam_points = torch.cat([cam_points, self.ones], 1)
#         # print(cam_points.size(),"cam_points-2")
#
#         return cam_points
#
#
...
#         # print(cam_points.size(), "cam_points")
#
...
#         # print(pix_coords.size(), "pix_coords")
#
#         return pix_coords
#
#
