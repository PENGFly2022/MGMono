...
def profile_once(encoder, decoder, x):
    ...
    # flops, params = clever_format([flops_e + flops_d, params_e ], "%.3f")
...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        encoder = networks.MGMono(model=opt.model,options=options,
        ...
        with torch.no_grad():
            for data in dataloader:
                ...
                t1 = time_sync()
                features, seg_features_map = encoder(input_color)
