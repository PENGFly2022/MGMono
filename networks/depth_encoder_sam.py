...
import torch.cuda
import sys
sys.path.append('/home/lsh/桌面/111TEST-SAM2/sam2-满级指导/hr-mono/segment-anything-2-main')  # 添加根目录路径
...
class LiteMono(nn.Module):
    ...
    def __init__(self, in_chans=3, model='lite-mono', height=192, width=640, patch_size=4, drop_rate=0.,
                 global_block=[1, 1, 1], global_block_type=['LGFI', 'LGFI', 'LGFI'], gf_depth=12, uniform_drop=False,
    ...
    def forward_features(self, x):
        ...
        # print(seg_feature[0].shape,'qqqqqqqqqqqqqqq')
